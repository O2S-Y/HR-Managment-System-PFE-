...
(3, 'oussama@newdev.ma','$2a$10$MV3A0JDLQepHDre7.Lb5AerhMzJBijef1vfEZ4VcMuzW1dJrn55Vy','EMPLOYE', TRUE),
(4, 'anass@newdev.ma',  '$2a$10$MV3A0JDLQepHDre7.Lb5AerhMzJBijef1vfEZ4VcMuzW1dJrn55Vy','EMPLOYE', TRUE);
...
(1, 3, 'Oussama Yinssi', 'AB987654', '1234567890', 'oussama@newdev.ma', '0612345678', '1997-10-15', '123 Boulevard d\'Anfa, Casablanca', 'Développement', 'Développeur Senior', 'CDI',   '2024-09-01', NULL,         'ACTIF', 15000.00, 1),
(2, 4, 'Anass Yinssi',   'CD123456', '9876543210', 'anass@newdev.ma',   '0655443322', '2000-05-20', '45 Avenue Mohammed V, Rabat',       'Design',        'UX Designer',        'CDD',   '2025-11-01', '2026-10-31', 'ACTIF',  9500.00, 0),
(3, 2, 'Responsable RH', 'RH789012', '9988776655', 'rh@newdev.ma',      '0699999999', '1990-01-01', 'Bureau RH, Casablanca',             'Ressources Humaines', 'DRH',             'CDI',   '2023-01-01', NULL,         'ACTIF', 18000.00, 3);
...
(1, NULL, 'LEAVE_SUBMITTED',           'Nouvelle demande de congé d\'Oussama Yinssi (5 jours)', FALSE, 1, 'LeaveRequest'),
